...
export function HoverCardImage({ image, title, content, date, tag, href }: HoverCardImagesProps) {
    return (
        <Link href={href}>
            <Card className="bg-[#36394b5d] backdrop-blur-md border-[#99CC33] ">
                ...
                <CardContent >
                        ...
                        <img src={image} alt="icon" className="rounded-3xl mt-7  h-32 w-60" />
                </CardContent>
                <CardFooter className=" flex flex-col">
                    <hr className="w-11/12 mx-auto border-t border-[#E4E4E7] pb-2" />
                    <div className="flex flex-row items-center">
                        <div className="flex justify-start pr-10"><p className="mt-5">{date}</p></div>
                        <div className="flex justify-end pl-10"><p className="mt-5">{tag}</p></div>
                    </div>
                </CardFooter>
            </Card>
        </Link>
