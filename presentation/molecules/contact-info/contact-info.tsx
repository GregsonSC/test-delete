        ...
        <section className="relative py-20">
          <div className="flex-row">
            ...
            <div className=" relative z-10 text-center w-full mx-auto">
              ...
              <p className="text-lg mb-8 text-[#0A1248] font-semibold">
                Let’s create a website that helps your business shine in Miami Beach! <br/>
                <Link href="/" className="text-white underline underline-offset-auto">
                  Contact us today for a free consultation
                </Link> and discover how a great web <br/>
