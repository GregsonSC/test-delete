                    ...
                    >
                        ...
                        <SelectContent>
                            <SelectGroup>
                                ...
                                <SelectItem value="UTC-08:00">(UTC-09:00) Anchorage, Juneau</SelectItem>
                                <SelectItem value="UTC-07:00">(UTC-08:00) Los Angeles, Vancouver</SelectItem>
                        ...
                        <div className="flex flex-col space-y-2 p-4">
                            {schedules.map((hour) => (
                                <Button
                                    ...
                                    onClick={() =>
                                        setSelection((prev) => ({ ...prev, hour: hour }))
                                    }
