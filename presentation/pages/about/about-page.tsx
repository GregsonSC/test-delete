      ...
      <section className="lg:bg-[url('/fondos/AboutUs.webp')] lg:bg-cover lg:bg-no-repeat">
        <section className="relative overflow-hidden text-center justify-center">
          ...
          >
            <video
              ...
              muted
            />
            <h1 className=" relative z-10 font-bold text-6xl md:text-8xl md:mx-32 mt-32 mb-56">
              About Us Title
            </h1>
          </motion.div>
        </section>
        ...
        <section className="items-center justify-center mb-20 mt-14 lg:mt-32 lg:mb-56">
          <motion.div
            ...
            transition={{ duration: 0.8, delay: 0.2, ease: "easeOut" }}
            className="flex flex-col items-center lg:flex lg:flex-row lg:ml-24 2xl:items-center 2xl:justify-center"
          >
            ...
            <div className="px-10 mt-5  lg:mb-0 lg:mt-0 lg:px-0 lg:ml-28 lg:h-80 lg:w-[596px] lg:mr-12">
              ...
              <p className="text-white text-opacity-70 text-center lg:text-justify">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ullamcorper vitae
                lacus eu convallis. Phasellus ut lectus dolor. Vestibulum eleifend orci non dapibus
                tincidunt. Phasellus vitae magna tincidunt, aliquam velit sit amet, convallis ante.
                Nunc non commodo nisi. Morbi libero leo, ultricies at iaculis ac, eleifend ut felis.
                Duis ipsum velit, vulputate id velit nec, condimentum eleifend lacus. Aliquam erat
                volutpat. Nunc ac ipsum in nulla volutpat fringilla. Sed et ligula pulvinar, tempus
                enim eget, pharetra odio. Nulla facilisi. Aliquam at lacus mi. Morbi nec risus quis
                dui maximus efficitur. Donec ut lacinia urna. Sed fermentum sem egestas fringilla
                porttitor. Cras sodales eu turpis quis tincidunt.
              </p>
            </div>
          </motion.div>
        </section>
        ...
        <section>
          <motion.div
            ...
            transition={{ duration: 0.8, delay: 0.2, ease: "easeOut" }}
            className="mx-8 flex flex-col items-center justify-center gap-8 md:p-0 md:grid md:grid-cols-2  md:justify-items-center lg:w-[888px] md:mx-auto"
          >
            {/* First Card */}
            <Card
              className="md:ml-10 lg:ml-0 md:p-4 bg-[#3f4049] rounded-lg border-2 border-transparent lg:h-[400px] lg:w-[418px]"
              style={{ borderImage: "linear-gradient(to right, #99CC33, #33CCCC, #99CC33) 2" }}
            >
            ...
            {/* Second Card */}
            <Card
              className="md:mr-10 lg:mr-0 md:p-4 bg-[#3f4049] rounded-lg border-2 border-transparent lg:h-[400px] lg:w-[418px]"
              style={{ borderImage: "linear-gradient(to right, #99CC33, #33CCCC, #99CC33) 2" }}
            >
              <CardTitle className="text-3xl lg:text-5xl font-bold mb-5 ml-4 mt-6">
                Our Mission
