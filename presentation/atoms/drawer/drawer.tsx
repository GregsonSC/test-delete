      ...
      <DrawerContent className="h-full w-[320px] right-0 left-auto fixed rounded-none bg-white">
        <div className="flex flex-col items-center justify-between h-full py-8">
          <DrawerHeader className="flex flex-col items-center relative">
            ...
            <DrawerTitle className="text-2xl font-semibold mb-1 text-black">{profileName}</DrawerTitle>
          ...
          <div className="flex flex-col items-center gap-4 mt-auto">
            <Button 
              variant="ghost" 
              className="flex items-center gap-2 text-black hover:bg-gray-100 rounded-full py-2 px-6 text-lg font-semibold justify-center"
            >
            ...
            <Button 
              onClick={onLogout}
              className="flex items-center gap-2 text-white hover:text-white rounded-full py-2 px-6 text-lg font-semibold justify-center shadow-md"
